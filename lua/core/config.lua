...
vim.opt.wrap = false -- Включить перенос строк, игнорируя целостность слов
...
vim.opt.shell = "/bin/zsh" -- Командная оболочка для выполнения внешних команд в NeoVim
...
vim.api.nvim_set_keymap("n", ".", "<Nop>", { silent = true }) -- Отключение повторения действия через символ '.'
